...
class UserTestCase(BaseTestCase):
    ...
    def test_register_with_invalid_password(self):
        ...
        response = self.test_client.post('/auth/register', data=json.dumps({"name":"Justine", "email":"justine@gmail.com", "username":"Tinah","password":"123"}), content_type = 'application/json')
        self.assertEqual(response.status_code, 400)
    ...
    def test_register_with_invalid_email(self):
        ...
        response = self.test_client.post('/auth/register', data=json.dumps({"name":"Justine", "email":"justine.com", "username":"Tinah","password":"12356"}), content_type = 'application/json')
        self.assertEqual(response.status_code, 400)
    ...
    def test_register_user_with_invalid_username(self):
        ...
        response = self.test_client.post('/auth/register', data=json.dumps({"name":"Justine", "email":"justine@gmail.com", "username":" ", "password":"123456"}), content_type='application/json')
        self.assertEqual(response.status_code, 400)
